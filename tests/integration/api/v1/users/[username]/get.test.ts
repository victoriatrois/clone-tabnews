...
describe("GET api/v1/users/[username]", () => {
  describe("Anonymous user", () => {
    test("With exact case match", async () => {
      ...
      const secondResponse = await fetch("http://localhost:3000/api/v1/users/ExactMatch");
    ...
    test("With case mismatch", async () => {
      ...
      const secondResponse = await fetch("http://localhost:3000/api/v1/users/casemismatch");
      expect(secondResponse.status).toBe(200);
    ...
    test("With a non-existing user", async () => {      
      const response = await fetch("http://localhost:3000/api/v1/users/nonExistingUser");
